...
namespace Blauhaus.Auth.Tests.UnitTests.Client.AzureAuthenticationClientServiceTests.Base
{
    ...
    {
        protected static readonly List<KeyValuePair<MsalLogLevel, string>> MockLogs = new List<KeyValuePair<MsalLogLevel, string>>
        {
            new KeyValuePair<MsalLogLevel, string>(MsalLogLevel.Verbose, "Verbose Log"),
            new KeyValuePair<MsalLogLevel, string>(MsalLogLevel.Info, "Info Log"),
            new KeyValuePair<MsalLogLevel, string>(MsalLogLevel.Warning, "Warning Log"),
            new KeyValuePair<MsalLogLevel, string>(MsalLogLevel.Error, "Error Log"),
        };
        ...
        protected AnalyticsServiceMockBuilder MockAnalyticsService;
        ...
        internal MockBuilder<IAzureActiveDirectoryClientConfig> MockConfig;
        ...
        protected readonly MsalClientResult MockAuthenticatedUserResult = MsalClientResult.Authenticated(new AuthenticationResultBuilder()
            ...
            .With_UniqueId(UserId.ToString()).Build(), MockLogs);
